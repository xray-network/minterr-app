  ...
  return (
    <div className="ray__block pt-3">
      <h1 className="text-center mb-4">
        ...
        <br />
        Vote for your idols! <span role="img" aria-label="">💫</span>
      </h1>
      <h5 className="text-center">Vote by sending any amount of ADA to the project address to get it up on the list.<br />1 <span className="ray__ticker">ADA</span> = 10 points. Remember stranger, the higher a project is on the list, the more attention it gets!</h5>
      <div className="text-muted text-center mb-5 pb-4 max-width-800 ms-auto me-auto">
        ...
        <p className="mb-0">Do you want to promote the NFT project? Send us a direct message on <a href="https://twitter.com/MinterrApp" target="_blank" rel="noopener noreferrer">Twitter</a>.</p>
      </div>
      {loading && (
